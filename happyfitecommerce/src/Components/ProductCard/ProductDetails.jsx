    ...
    <div class="top-margin d-flex gap-4 justify-center">
      ...
      <div class="content-container content-box col-flex gap-1">
        ...
        <div class="cta d-flex gap">
          <button
            className={`${
              outOfStock ? `strik-through` : `cursor`
            } button btn-primary btn-icon d-flex btn-margin gap align-center`}
            disabled={outOfStock}
          ></button>
          <button className="button btn-outline-primary btn-icon d-flex align-center gap cursor btn-margin"></button>
        </div>
      </div>
    </div>
  );
